    ...
    <div className="min-h-screen md:mb-[-40px] mb-10 px-0 mx-1 md:mx-10">
      ...
      <div className="flex gap-6 pt-6 px-4">
        <div className="relative w-52 shrink-0 aspect-[2/3]">
          <Image src={anime.data.images.webp.image_url} alt={anime.data.title} fill className="object-cover rounded-md" />
        </div>
        <div className="flex flex-col gap-2">
          <div>
            <h1 className="text-color-blue text-lg underline">Peringkat:</h1>
            <p className="text-color-font text-md md:text-lg">{anime.data.rank}</p>
          </div>
          <div>
            <h1 className="text-color-blue text-lg underline">Skor:</h1>
            <p className="text-color-font text-md md:text-lg">{anime.data.score}</p>
          </div>
          <div>
            <h1 className="text-color-blue text-lg underline">Duration:</h1>
            <p className="text-color-font text-md md:text-lg">{anime.data.duration}</p>
          </div>
          <div>
            <h1 className="text-color-blue text-lg underline">Genres:</h1>
          ...
          <div>
            <h1 className="text-color-blue text-lg underline">Episode:</h1>
            <p className="text-color-font text-lg">{anime.data.episodes}</p>
          </div>
        </div>
      </div>
      <div className='px-4 pt-6'>
        <h1 className="text-xl mb-2 w-fit text-color-blue rounded font-semibold underline">Synopsis :</h1>
